 ...
 */
package com.buaa.cfs.mount;

import com.buaa.cfs.common.oncrpc.RpcProgram;
import com.buaa.cfs.common.oncrpc.SimpleTcpServer;
import com.buaa.cfs.common.oncrpc.SimpleUdpServer;
...
/**
 * Main class for starting mountd daemon. This daemon implements the NFS mount protocol. When receiving a MOUNT request
 * from an NFS client, it checks the request against the list of currently exported file systems. If the client is
 * permitted to mount the file system, rpc.mountd obtains a file handle for requested directory and returns it to the
 * client.
 */
