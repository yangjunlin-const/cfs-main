...
import com.buaa.cfs.utils.IdentityHashStore;
...
/**
 * Utility that wraps a {@link } in a {@link DataInputStream} and buffers input through a {@link BufferedInputStream}.
 */
public class FSDataInputStream extends DataInputStream
    ...
    /**
     * Map ByteBuffers that we have handed out to readers to ByteBufferPool objects
     */
     ...
     *
     * @return total number of bytes read into the buffer, or <code>-1</code> if there is no more data because the end
    ...
    /**
     * Read bytes from the given position in the stream to the given buffer. Continues to read until <code>length</code>
     ...
     *
     * @throws EOFException If the end of stream is reached while reading. If an exception is thrown an undetermined
     *                      number of bytes in the buffer may have been written.
     */
    @Override
