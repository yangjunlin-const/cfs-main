...
/**
 * Names a file or directory in a . Path strings use slash as the directory separator.  A path string is absolute if it
 * begins with a slash.
 */
public class Path implements Comparable {
    ...
    /**
     * Construct a path from a String.  Path strings are URIs, but with unescaped elements and some additional
     * normalization.
     */
     ...
     * there is a scheme and authority.
     */
