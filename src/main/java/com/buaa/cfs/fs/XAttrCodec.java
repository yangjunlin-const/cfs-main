...
/**
 * The value of <code>XAttr</code> is byte[], this class is to covert byte[] to some kind of string representation or
 * convert back. String representation is convenient for display and input. For example display in screen as shell
 * response and json response, input as http or shell parameter.
 */
