...
public class DU extends Shell {
     ...
     * <p>
     * Future improvements could be to not permanently run this thread, instead run when getUsed is called.
     **/
    ...
    /**
     * Override to hook in DUHelper class. Maybe this can be used more generally as well on Unix/Linux based systems
     */
    @Override
