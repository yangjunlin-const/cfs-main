...
/**
 * Defines properties of a CipherSuite. Modeled after the ciphers in {@link javax.crypto.Cipher}.
 */
public enum CipherSuite {
    ...
    /**
     * Convert to CipherSuite from name, {@link #algoBlockSize} is fixed for certain cipher suite, just need to compare
     * the name.
     *
