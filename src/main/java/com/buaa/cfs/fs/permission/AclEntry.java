...
/**
 * Defines a single entry in an ACL.  An ACL entry has a type (user, group, mask, or other), an optional name (referring
 * to a specific user or group), a set of permissions (any combination of read, write and execute), and a scope (access
 * or default).  AclEntry instances are immutable.  Use a {@link Builder} to create a new instance.
 */
public class AclEntry {
    ...
    public static class Builder {
        ...
        /**
         * Sets the scope of the ACL entry.  If this method is not called, then the builder assumes {@link
    ...
    /**
     * Parses a string representation of an ACL spec into a list of AclEntry objects. Example:
     * "user::rwx,user:foo:rw-,group::r--,other::---"
     *
     * @param aclSpec           String representation of an ACL spec.
     * @param includePermission for setAcl operations this will be true. i.e. AclSpec should include permissions.<br>
     *                          But for removeAcl operation it will be false. i.e. AclSpec should not contain
     *                          permissions.<br> Example: "user:foo,group:bar"
     *
     ...
     *
     * @param aclStr            String representation of an ACL.<br> Example: "user:foo:rw-"
     * @param includePermission for setAcl operations this will be true. i.e. Acl should include permissions.<br> But
     *                          for removeAcl operation it will be false. i.e. Acl should not contain permissions.<br>
