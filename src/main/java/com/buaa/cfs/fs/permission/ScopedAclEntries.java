...
/**
 * Groups a list of ACL entries into separate lists for access entries vs. default entries.
 */
public final class ScopedAclEntries {
    ...
    /**
     * Creates a new ScopedAclEntries from the given list.  It is assumed that the list is already sorted such that all
     * access entries precede all default entries.
     *
     ...
     *
     * @return List<AclEntry> containing just access entries, or an empty list if there are no access entries
     */
     ...
     *
     * @return List<AclEntry> containing just default entries, or an empty list if there are no default entries
     */
    ...
    /**
     * Returns the pivot point in the list between the access entries and the default entries.  This is the index of the
     * first element in the list that is a default entry.
     *
