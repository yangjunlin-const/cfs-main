 ...
 */
package com.buaa.cfs.fs.permission;
...
import com.buaa.cfs.io.WritableFactories;
import com.buaa.cfs.io.WritableFactory;
...
public class FsPermission implements Writable {
    ...
    /**
     * Encodes the object to a short.  Unlike {@link #toShort()}, this method may return values outside the fixed range
     * 00000 - 01777 if extended features are encoded into this permission, such as the ACL bit.
     *
     ...
     * <p>
     * The umask is used by create, mkdir, and other Hadoop filesystem operations. The mode argument for these
     * operations is modified by removing the bits which are set in the umask.  Thus, the umask limits the permissions
     * which newly created files and directories get.
     *
     ...
     * <p>
     * {@code UMASK_LABEL} config param has umask value that is either symbolic or octal.
     * <p>
     * Symbolic umask is applied relative to file mode creation mask; the permission op characters '+' clears the
     * corresponding bit in the mask, '-' sets bits in the mask.
     * <p>
    ...
    /**
     * Get the default permission for directory and symlink. In previous versions, this default permission was also used
     * to create files, so files created end up with ugo+x permission. See HADOOP-9155 for detail. Two new methods are
     * added to solve this, please use {@link FsPermission#getDirDefault()} for directory, and use {@link
     * FsPermission#getFileDefault()} for file. This method is kept for compatibility.
     */
