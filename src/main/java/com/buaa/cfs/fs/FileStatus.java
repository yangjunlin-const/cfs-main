...
public class FileStatus implements Writable, Comparable {
    ...
    /**
     * Old interface, instead use the explicit {@link FileStatus#isFile()}, {@link FileStatus#isDirectory()}, and {@link
     * FileStatus#isSymlink()}
     *
     * @return true if this is a directory.
     *
     * @deprecated Use {@link FileStatus#isFile()}, {@link FileStatus#isDirectory()}, and {@link FileStatus#isSymlink()}
     * instead.
     */
    @Deprecated
     ...
     *
     * @return permssion. If a filesystem does not have a notion of permissions or if permissions could not be
     * determined, then default permissions equivalent of "rwxrwxrwx" is returned.
     */
     ...
     *
     * @return owner of the file. The string could be empty if there is no notion of owner of a file in a filesystem or
     * if it could not be determined (rare).
     */
     ...
     *
     * @return group for the file. The string could be empty if there is no notion of group of a file in a filesystem or
     * if it could not be determined (rare).
     */
   ...
   */
     ...
     *
     * @throws ClassCastException if the specified object's is not of type FileStatus
     */
    @Override
