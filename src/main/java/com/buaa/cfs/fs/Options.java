...
public final class Options {
    ...
    public static class CreateOpts {
         ...
         *
         * @return an opt from one of the opts of type theClass. returns null if there isn't any
         */
    ...
    public static class ChecksumOpt {
        ...
        /**
         * A helper method for processing user input and default value to create a combined checksum option. This is a
         * bit complicated because bytesPerChecksum is kept for backward compatibility.
         *
         * @param defaultOpt           Default checksum option
         * @param userOpt              User-specified checksum option. Ignored if null.
         * @param userBytesPerChecksum User-specified bytesPerChecksum Ignored if < 0.
         */
