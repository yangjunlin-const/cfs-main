...
/****************************************************************
 * Abstract Checksumed FileSystem. It provide a basic implementation of a Checksumed FileSystem, which creates a
 * checksum file for each raw file. It generates & verifies checksums at the client side.
 *****************************************************************/
public abstract class ChecksumFileSystem extends FilterFileSystem {
    ...
    /*******************************************************
     * For open()'s FSInputStream It verifies that data matches checksums.
     *******************************************************/
    ...
    private static class FSDataBoundedInputStream extends FSDataInputStream {
         ...
         * <p>
         * The <code>skip</code> method skips over some smaller number of bytes when reaching end of file before
         * <code>n</code> bytes have been skipped. The actual number of bytes skipped is returned.  If <code>n</code> is
         ...
         *
         * @throws IOException if an I/O error occurs or seeks after EOF ChecksumException if the chunk to seek to is
         *                     corrupted
         */
    ...
    /**
     * This class provides an output stream for a checksummed file. It generates checksums for data.
     */
    ...
    /**
     * Set replication for an existing file. Implement the abstract <tt>setReplication</tt> of <tt>FileSystem</tt>
     *
     * @param src         file name
    ...
    /**
     * The src file is under FS, and the dst is on the local disk. Copy it from FS control to the local dst name. If src
     * and dst are directories, the copyCrc parameter determines whether to copy CRC files.
     */
