 ...
 * <p>
 * It includes all publicly documented configuration keys. In general this class should not be used directly (use
...
public class CommonConfigurationKeysPublic {
    ...
    /**
     * @deprecated Moved to mapreduce, see mapreduce.task.io.sort.mb in mapred-default.xml See
     * https://issues.apache.org/jira/browse/HADOOP-6801
     */
    ...
    /**
     * @deprecated Moved to mapreduce, see mapreduce.task.io.sort.factor in mapred-default.xml See
     * https://issues.apache.org/jira/browse/HADOOP-6801
     */
