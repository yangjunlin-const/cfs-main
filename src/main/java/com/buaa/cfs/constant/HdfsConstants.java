...
public class HdfsConstants {
    ...
    /**
     * A prefix put before the namenode URI inside the "service" field of a delgation token, indicating that the URI is
     * a logical (HA) URI.
     */
...
//    };
    ...
    /**
     * Current layout version for NameNode. Please see {@link NameNodeLayoutVersion.Feature} on adding new layout
     * version.
     */
...
//            = NameNodeLayoutVersion.CURRENT_LAYOUT_VERSION;
    ...
    /**
     * Current layout version for DataNode. Please see {@link DataNodeLayoutVersion.Feature} on adding new layout
     * version.
     */
