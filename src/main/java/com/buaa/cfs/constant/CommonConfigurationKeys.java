 ...
 * <p>
 * It inherits all the publicly documented configuration keys and adds unsupported keys.
 */
...
public class CommonConfigurationKeys extends CommonConfigurationKeysPublic {
    ...
    /**
     * CallQueue related settings. These are not used directly, but rather combined with a namespace and port. For
     * instance: IPC_CALLQUEUE_NAMESPACE + ".8020." + IPC_CALLQUEUE_IMPL_KEY
     */
