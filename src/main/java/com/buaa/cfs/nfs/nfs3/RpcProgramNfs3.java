...
import com.buaa.cfs.nfs.common.oncrpc.security.*;
import com.buaa.cfs.nfs.request.*;
import com.buaa.cfs.nfs.response.*;
...
import static com.buaa.cfs.constant.Nfs3Constant.NFSPROC3;
import static com.buaa.cfs.constant.Nfs3Constant.WriteStableHow;
...
//            IOException io = r.unwrapRemoteException();
    ...
    ACCESS3Response access(XDR xdr, SecurityHandler securityHandler,
        ...
        LOG.info("--- getuser is :" + securityHandler.getUser());
        DFSClient dfsClient = clientCache.getDfsClient(securityHandler.getUser());
        if (dfsClient == null) {
            response.setStatus(Nfs3Status.NFS3ERR_SERVERFAULT);
            return response;
...
//            }
    ...
    public READDIR3Response readdir(XDR xdr, SecurityHandler securityHandler,
        ...
        try {
            ...
            if (cookie == 0) {
                // Get dotdot fileId
                String dotdotFileIdPath = dirFileIdPath + "/src/main";
        ...
        if (cookie == 0) {
            ...
            entries[1] = new READDIR3Response.Entry3(dotdotFileId, "src/main", dotdotFileId);
