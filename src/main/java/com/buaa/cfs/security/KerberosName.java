...
public class KerberosName {
    ...
    /**
     * A pattern that matches a string with out '$' and then a single parameter with $n.
     */
    ...
    private static class Rule {
        ...
        /**
         * Replace the numbered parameters of the form $n where n is from 1 to the length of params. Normal text is
         * copied directly and $n is replaced by the corresponding parameter.
         *
         ...
         *
         * @param params first element is the realm, second and later elements are are the components of the name
         *               "a/b@FOO" -> {"FOO", "a", "b"}
         *
