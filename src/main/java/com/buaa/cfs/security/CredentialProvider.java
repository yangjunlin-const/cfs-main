...
/**
 * A provider of credentials or password for Hadoop applications. Provides an abstraction to separate credential storage
 * from users of them. It is intended to support getting or storing passwords in a variety of ways, including third
 * party bindings.
 */
public abstract class CredentialProvider {
    ...
    /**
     * Indicates whether this provider represents a store that is intended for transient use - such as the UserProvider
     * is. These providers are generally used to provide job access to passwords rather than for long term storage.
     *
