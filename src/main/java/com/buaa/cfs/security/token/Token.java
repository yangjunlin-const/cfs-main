...
public class Token<T extends TokenIdentifier> implements Writable {
    ...
    /**
     * Set the token kind. This is only intended to be used by services that wrap another service's token, such as HFTP
     * wrapping HDFS.
     *
     * @param newKind
     */
    ...
    /**
     * Indicates whether the token is a clone.  Used by HA failover proxy to indicate a token should not be visible to
     * the user via UGI.getCredentials()
     */
    ...
    /**
     * A trivial renewer for token kinds that aren't managed. Sub-classes need to implement getKind for their token
     * kind.
     */
