...
import com.buaa.cfs.constant.PlatformName;
...
public class KerberosUtil {
    ...
    /**
     * Create Kerberos principal for a given service and hostname. It converts hostname to lower case. If hostname is
     * null or "0.0.0.0", it uses dynamically looked-up fqdn of the current host instead.
     *
