...
public interface GSet<K, E extends K> extends Iterable<E> {
    ...
    /**
     * Add/replace an element. If the element does not exist, add it to the set. Otherwise, replace the existing
     * element.
     * <p>
     * Note that this operation is similar to {@link java.util.Map#put(Object, Object)} but is different from {@link
     * java.util.Set#add(Object)} which does not replace the existing element if there is any.
     *
