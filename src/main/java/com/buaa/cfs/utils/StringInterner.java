...
/**
 * Provides equivalent behavior to String.intern() to optimize performance, whereby does not consume memory in the
...
public class StringInterner {
    ...
    /**
     * Interns and returns a reference to the representative instance for any of a collection of string instances that
     * are equal to each other. Retains strong reference to the instance, thus preventing it from being
     * garbage-collected.
     *
    ...
    /**
     * Interns and returns a reference to the representative instance for any of a collection of string instances that
     * are equal to each other. Retains weak reference to the instance, and so does not prevent it from being
     * garbage-collected.
     *
     * @param sample string instance to be interned
     *
