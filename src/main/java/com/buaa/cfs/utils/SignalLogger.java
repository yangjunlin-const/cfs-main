...
/**
 * This class logs a message whenever we're about to exit on a UNIX signal. This is helpful for determining the root
 * cause of a process' exit. For example, if the process exited because the system administrator ran a standard "kill,"
