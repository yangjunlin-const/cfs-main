...
/**
 * A low memory footprint {@link GSet} implementation, which uses an array for storing the elements and linked lists for
 * collision resolution.
 * <p>
 * No rehash will be performed. Therefore, the internal array will never be resized.
 * <p>
 ...
 * @param <E> Element type, which must be (1) a subclass of K, and (2) implementing {@link LinkedElement} interface.
 */
public class LightWeightGSet<K, E extends K> implements GSet<K, E> {
    ...
    /**
     * Let t = percentage of max memory. Let e = round(log_2 t). Then, we choose capacity = 2^e/(size of reference),
