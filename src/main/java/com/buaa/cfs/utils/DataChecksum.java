...
public class DataChecksum implements Checksum {
    ...
    /**
     * This constructs a DataChecksum by reading HEADER_LEN bytes from input stream <i>in</i>
     */
     ...
     * <p>
     * The 'mark' of the ByteBuffer parameters may be modified by this function,. but the position is maintained.
     *
     * @param data      the DirectByteBuffer pointing to the data to verify.
     * @param checksums the DirectByteBuffer pointing to a series of stored checksums
    ...
    /**
     * Implementation of chunked verification specifically on byte arrays. This is to avoid the copy when dealing with
     * ByteBuffers that have array backing.
     */
     ...
     * @param checksums the DirectByteBuffer into which checksums will be stored. Enough space must be available in this
    ...
    /**
     * Implementation of chunked calculation specifically on byte arrays. This is to avoid the copy when dealing with
     * ByteBuffers that have array backing.
     */
    ...
    /**
     * This just provides a dummy implimentation for Checksum class This is used when there is no checksum available or
     * required for data
     */
