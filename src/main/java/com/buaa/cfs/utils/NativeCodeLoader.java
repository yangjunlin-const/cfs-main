...
/**
 * A helper to load the native hadoop code i.e. libhadoop.so. This handles the fallback to either the bundled
 * libhadoop-Linux-i386-32.so or the default java implementations where appropriate.
 */
public class NativeCodeLoader {
     ...
     *
     * @return <code>true</code> if native hadoop libraries, if present, can be used for this job; <code>false</code>
     * otherwise.
     */
