...
public class GenericsUtil {
    ...
    /**
     * Returns the Class object (of type <code>Class&lt;T&gt;</code>) of the argument of type <code>T</code>.
     *
     ...
     * @param list the list to convert
     *
     * @throws ArrayIndexOutOfBoundsException if the list is empty. Use {@link #toArray(Class, List)} if the list may be
     *                                        empty.
     */
