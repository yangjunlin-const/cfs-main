...
import com.buaa.cfs.nfs3.NfsTime;
import com.buaa.cfs.common.oncrpc.XDR;

import java.util.EnumSet;

/**
 * SetAttr3 contains the file attributes that can be set from the client. The fields are the same as the similarly named
 * fields in the NFS3Attributes structure.
 */
