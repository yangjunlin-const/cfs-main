...
/**
 * A class that provides direct and reverse lookup functionalities, allowing the querying of specific network interfaces
 * or nameservers.
 */
public class DNS {
    ...
    /**
     * Like {@link DNS#getIPs(String, boolean), but returns all IPs associated with the given interface and its
     * subinterfaces.
     */
    ...
    /**
     * Returns the first available IP address associated with the provided network interface or the local host IP if
     * "default" is given.
     *
     * @param strInterface The name of the network interface or subinterface to query (e.g. eth0 or eth0:0) or the
     *                     string "default"
     *
     * @return The IP address in text form, the local host IP is returned if the interface name "default" is specified
     *
     * @throws UnknownHostException If the given interface is invalid
     */
     ...
     * be determined. If the loopback address of "localhost" does not resolve, then the system's network is in such a
     * state that nothing is going to work. A message is logged at the error level and a null pointer returned, a
     * pointer which will trigger failures later on the application
     *
    ...
    /**
     * Returns all the host names associated by the default nameserver with the address bound to the specified network
     * interface
     *
    ...
    /**
     * Returns the default (first) host name associated by the provided nameserver with the address bound to the
    ...
    /**
     * Returns the default (first) host name associated by the default nameserver with the address bound to the
     * specified network interface
     *
     * @param strInterface The name of the network interface to query (e.g. eth0). Must not be null.
     *
