...
import com.buaa.cfs.io.LongWritable;
...
/**
 * This implements an output stream that can have a timeout while writing. This sets non-blocking flag on the socket
 * channel. So after creating this object , read() on {@link Socket#getInputStream()} and write() on {@link
 * Socket#getOutputStream()} on the associated socket will throw llegalBlockingModeException. Please use {@link
 * SocketInputStream} for reading.
 */
public class SocketOutputStream extends OutputStream
    ...
    /**
     * Create a new ouput stream with the given timeout. If the timeout is zero, it will be treated as infinite timeout.
     * The socket's channel will be configured to be non-blocking.
     *
     * @param channel Channel for writing, should also be a {@link SelectableChannel}. The channel will be configured to
     *                be non-blocking.
    ...
    /**
     * Returns underlying channel used by this stream. This is useful in certain cases like channel for {@link
    ...
    /**
     * waits for the underlying channel to be ready for writing. The timeout specified for this stream applies to this
     * wait.
     *
    ...
    /**
     * Transfers data from FileChannel using {@link FileChannel#transferTo(long, long, WritableByteChannel)}. Updates
     * <code>waitForWritableTime</code> and <code>transferToTime</code> with the time spent blocked on the network and
     * the time spent transferring data from disk to network respectively.
     * <p>
     ...
     * @param waitForWritableTime nanoseconds spent waiting for the socket to become writable
     *
     * @throws EOFException           If end of input file is reached before requested number of bytes are transfered.
     * @throws SocketTimeoutException If this channel blocks transfer longer than timeout for this stream.
     * @throws IOException            Includes any exception thrown by {@link FileChannel#transferTo(long, long,
     *                                WritableByteChannel)}.
     */
    ...
    /**
     * <code>waitForWritableTime</code> and <code>transferToTime</code>
     */
    public void transferToFully(FileChannel fileCh, long position, int count)
            throws IOException {
