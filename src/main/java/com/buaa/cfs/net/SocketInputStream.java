...
/**
 * This implements an input stream that can have a timeout while reading. This sets non-blocking flag on the socket
 * channel. So after create this object, read() on {@link Socket#getInputStream()} and write() on {@link
 * Socket#getOutputStream()} for the associated socket will throw IllegalBlockingModeException. Please use {@link
 * SocketOutputStream} for writing.
 */
public class SocketInputStream extends InputStream
    ...
    /**
     * Create a new input stream with the given timeout. If the timeout is zero, it will be treated as infinite timeout.
     * The socket's channel will be configured to be non-blocking.
     *
     * @param channel Channel for reading, should also be a {@link SelectableChannel}. The channel will be configured to
     *                be non-blocking.
    ...
    /**
     * Same as SocketInputStream(socket.getChannel(), socket.getSoTimeout()) :<br><br>
     * <p>
     * Create a new input stream with the given timeout. If the timeout is zero, it will be treated as infinite timeout.
     * The socket's channel will be configured to be non-blocking.
     *
    ...
    /**
     * Returns underlying channel used by inputstream. This is useful in certain cases like channel for {@link
    ...
    /**
     * waits for the underlying channel to be ready for reading. The timeout specified for this stream applies to this
     * wait.
     *
