...
/**
 * A byte array backed output stream with a limit. The limit should be smaller than the buffer capacity. The object can
 * be reused through <code>reset</code> API and choose different limits in each round.
 */
