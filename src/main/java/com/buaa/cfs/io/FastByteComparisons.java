...
/**
 * Utility code to do optimized byte-array comparison. This is borrowed and slightly modified from Guava's {@link
 * UnsignedBytes} class to be able to compare arrays that start at non-zero offsets.
 */
